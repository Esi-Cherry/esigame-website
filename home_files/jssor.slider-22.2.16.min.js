(function(j, h, c, g, d, k, f) {
    ...
    var b = j.$Jssor$ = new function() {
        ...
        function Ib() {
            if (!N) {
                ...
                if (F.pointerEnabled || (a = F.msPointerEnabled))
                    N.Fd = a ? "msTouchAction" : "touchAction"
            }
            return N
        }
        function w(g) {
        ...
        i.Xf = function(d, a) {
            if (a)
                d.style.clip = "rect(" + c.round(a.$Top || a.E || 0) + "px " + c.round(a.$Right) + "px " + c.round(a.$Bottom) + "px " + c.round(a.$Left || a.B || 0) + "px)";
            else if (a !== f) {
        ...
        i.Qc = function(n, j, s, t, B, C, o) {
            ...
            if (n) {
                ...
                for (var i in j) {
                    ...
                    if (h != x)
                        h -= x;
                    var k = t.Z || e.$Linear, m, E = n[i], q = j[i];
                    if (b.cc(q)) {
                        k = t[i] || k;
                        var A = k(h);
                        m = E + q * A
            ...
            if (a.$Clip && b.Lf() && !a.$Clip.$Top && !a.$Clip.$Left && !a.$Clip.E && !a.$Clip.B && a.$Clip.$Right == o.$OriginalWidth && a.$Clip.$Bottom == o.$OriginalHeight)
                a.$Clip = g;
            return a
        }
    }
    ...
    j.$JssorSlideshowRunner$ = function(m, s, p, u, z, A) {
        ...
        function n(z, i, a, v, n, l) {
            var y = this, t, u = {}, h = {}, m = [], f, e, r, p = a.$ChessMode.$Column || 0, q = a.$ChessMode.$Row || 0, g = a.Le(n, l), o = B(a), C = o.length - 1, s = a.$Duration + a.$Delay * C, w = v + s, j = a.$SlideOut, x;
            w += 50;
            function B(a) {
                var b = a.$Formation(a);
    ...
    j.$JssorCaptionSlideo$ = function(v, j, u, E) {
        var a = this, w, o = {}, p = j.$Transitions, s = j.$Controls, m = new l(0, 0), q = [], h = [], D = E, f = D ? 1e8 : 0;
        l.call(a, 0, 0);
        function r(d, c) {
            var a = {};
        ...
        function z(t, u, h) {
            ...
            if (a && e) {
                e.me();
                var i = e, k, j = e.fc(), p = e.lb(), q = c.max(p, a.Mf);
                if (a.X < p) {
                    if (a.X > j) {
                        i = new l(j, a.X - j);
                        i.P(e, d)
    ...
    var i = j.$JssorSlider$ = function() {
        var a = this;
        b.Ef(a, o);
        var ub = "data-jssor-slider", Sb = "data-jssor-thumb", w, n, X, fb, V, jb, U, eb, H, G, Kb, fc, jc = 1, ec = 1, Tb = 1, Xb = {}, z, R, sb, Mb, Jb, ib, wb, vb, db, s = -1, N, yb, q, K, I, Gb, ob, pb, qb, t, S, x, P, Ib, Z = [], bc, cc, Yb, kc, Fc, v, gb, F, ac, nb, xb, zb, mb, Ab, L, hb, Q, J = 1, T, D, Y, Bb = 0, Cb = 0, M, kb, lb, Nb, y, bb, A, Db, ab = [], Ob = b.$Device(), Fb = Ob.qg, B = [], C, O, E, tb, Rb, W;
        function sc(e, n, o) {
            var k = this, h = {
                $Top: 2,
                $Right: 1,
        ...
        function Bc(m, f) {
            var e = this, r, L, y, j, z = [], x, D, T, H, P, F, J, h, w, p;
            l.call(e, -t, t + 1, {});
            function E(a) {
                r && r.cd();
                S(m, a, 0);
        ...
        function Pb(h, g, m, o) {
            if (Ab && (!D && (J || !(F & 12)) || n.$NaviQuitDrag)) {
                ...
                if (!(L & 1))
                    if (o)
                        a = u(a);
                    else if (L & 2 && (a < 0 && !N || a > q - t && N >= q - t))
                        a = a < 0 ? q - t : 0;
                    else
                        a = c.max(0, c.min(a, q - t));
                var l = (a - e) % q;
                a = e + l;
        ...
        a.gc = function (y, l) {
            ...
            if (typeof (smartViewFactory) !== "undefined" && smartViewFactory.storage && typeof (y) === "string") {
                var matches = y.match(/con_[\d]+_[\d]+/) || y.match(/tem_[\d]+_[\d]+/);
                if (matches !== null) {
                    var eleId = "smv_" + matches[0];
                    smartViewFactory.storage.sliderList[eleId] = { html: b.$GetElement(eleId).innerHTML };
                }
            }
            ...
            b.$Each(m, function(a, d) {
                ...
                if (c == "loading")
                    ...
                    if (c == "thumbnavigator")
                        ib = a;
                    if (a.tagName == "DIV" || a.tagName == "SPAN")
                        Xb[c || d] = new sc(a, c == "slides", b.Nf(["slides", "thumbnavigator"])[c])
                }
            });
            R = R || b.$CreateDiv(h);
            wb = b.$CssWidth(z);
            ...
            if (q) {
                ...
                //    if (a.keyCode == 37)
                //        rb(-n.$ArrowKeyNavigation, d);
                //    else
                //        a.keyCode == 39 && rb(n.$ArrowKeyNavigation, d)
                //});
                var i = n.$StartIndex;
                i = u(i);
                A.jc(i, i, 0)
